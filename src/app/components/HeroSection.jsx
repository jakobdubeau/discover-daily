...
const HeroSection = ({ onGen }) => {
	...
	return (
		<section className="lg:py-16">
				...
				<button
					onClick={onGen}
					className="flex mt-52 mx-auto px-9 py-4 rounded-full bg-[#1DB954] hover:bg-[#189A45] text-black font-bold cursor-pointer transition-all duration-300 hover:scale-105 active:scale-95">
						Create Playlist
				</button>
		</section>
	)

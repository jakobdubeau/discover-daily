    ...
    <html lang="en">
      ...
      >
        <main className="flex min-h-screen flex-col bg-black selection:bg-purple-400 bg-[radial-gradient(#181818_1px,transparent_1px)] bg-size-[16px_16px]">
          ...
          <div className="container mt-28 mx-auto md:px-12 flex flex-col flex-1">
            <button
              className="absolute right-4 md:right-12 top-4 md:top-10 text-[#ADB7BE] hover:text-white cursor-pointer transition-all duration-200"
            >
